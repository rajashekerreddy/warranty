  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved photo as @photo" do
        ...
        post :create, {:photo => { "content" => "invalid value" }}, valid_session
        expect(assigns(:photo)).to be_a_new(Photo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested photo" do
        ...
        expect_any_instance_of(Photo).to receive(:update_attributes).with({ "content" => "MyText" })
        put :update, {:id => photo.to_param, :photo => { "content" => "MyText" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the photo as @photo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Photo.any_instance.stub(:save).and_return(false)
        put :update, {:id => photo.to_param, :photo => { "content" => "invalid value" }}, valid_session
        expect(assigns(:photo)).to eq(photo)
      end
